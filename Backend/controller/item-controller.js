...
const createItem = async (req, res, next) => {
    ...
    const {image,name, price , is_active ,Detail, desc, Category_name ,Category_id,rating} = req.body;

    

    const Items1 = new items({ image,name, price , is_active , Detail,desc, Category_name,Category_id,rating });
